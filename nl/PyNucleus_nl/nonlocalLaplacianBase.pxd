...
include "nonlocalLaplacianBase_decl_REAL.pxi"
include "nonlocalLaplacianBase_decl_COMPLEX.pxi"
...
#     # private
#     cdef void eval_distant_tensor(self, REAL_t[::1] contrib, panelType panel, MASK_t mask=*)
#     cdef void eval_distant_tensor_boundary(self, REAL_t[::1] contrib, panelType panel, MASK_t mask=*)
#     cdef void eval_distant_vector(self, REAL_t[:, ::1] contrib, panelType panel, MASK_t mask=*)
#     cdef void eval_distant_nonsym_vector(self, REAL_t[:, ::1] contrib, panelType panel, MASK_t mask=*)
#     cdef void eval_distant_boundary_vector(self, REAL_t[:, ::1] contrib, panelType panel, MASK_t mask=*)
#     # release
