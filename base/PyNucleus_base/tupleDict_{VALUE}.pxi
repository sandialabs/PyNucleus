...
cdef class tupleDict{VALUE}:
    def __init__(self,
        ...
        self.vals = <{VALUE_t} **>PyMem_Malloc(num_dofs*sizeof({VALUE_t} *))
        ...
        for i in range(num_dofs):
            ...
            self.vals[i] = <{VALUE_t} *>PyMem_Malloc(self.initial_length * sizeof({VALUE_t}))
    ...
    cdef inline void increaseSize(self, INDEX_t I, {LENGTH_t} increment):
        ...
        self.indexL[I] = <INDEX_t *>PyMem_Realloc(self.indexL[I], (self.lengths[I]) * sizeof(INDEX_t))
        self.vals[I] = <{VALUE_t} *>PyMem_Realloc(self.vals[I], (self.lengths[I]) * sizeof({VALUE_t}))
    ...
    def __setstate__(self, state):
        ...
        for i in range(self.num_dofs):
            ...
            self.indexL[i] = <INDEX_t *>PyMem_Malloc(self.lengths[i] * sizeof(INDEX_t))
            self.vals[i] = <{VALUE_t} *>PyMem_Malloc(self.lengths[i] * sizeof({VALUE_t}))
            for j in range(self.counts[i]):
